  ...
  public: {
    Tables: {
      ai_judgments: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_judgments_topic_id_fkey"
            columns: ["topic_id"]
            referencedRelation: "topics"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "ai_judgments_user_id_fkey"
            columns: ["user_id"]
      ...
      cash_transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "cash_transactions_topic_id_fkey"
            columns: ["topic_id"]
            referencedRelation: "topics"
            referencedColumns: ["id"]
          },
      ...
      points_transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "points_transactions_topic_id_fkey"
            columns: ["topic_id"]
            referencedRelation: "topics"
            referencedColumns: ["id"]
          },
      ...
      topics: {
        Row: {
          ...
          heat: number | null
          id: string
          leading_camp: number | null
          raw_votes: number[] | null
          sponsored_by: string | null
          status: string | null
          support_pool: number | null
          title: string
